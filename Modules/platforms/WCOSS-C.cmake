macro (setWCOSS_C)
  ...
  set(GSI_Platform_FLAGS "-DPOUND_FOR_STRINGIFY ${FP_MODEL_STRICT} ${BYTERECLEN} ${BIG_ENDIAN} ${IMPLICITNONE} -D_REAL8_ ${OpenMP_Fortran_FLAGS} ${MPI_Fortran_COMPILE_FLAGS} ${FOPT3}" CACHE INTERNAL "")
  set(ENKF_Platform_FLAGS "${FOPT3} ${FP_MODEL_STRICT} ${BIG_ENDIAN} ${BYTERECLEN} ${IMPLICITNONE}  -DGFS -D_REAL8_ ${OpenMP_Fortran_FLAGS} " CACHE INTERNAL "")
