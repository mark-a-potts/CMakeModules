function (setGNU)
  ...
  if( (BUILD_RELEASE) OR (BUILD_PRODUCTION) )
    ...
    set(EXTRA_LINKER_FLAGS "-lgomp" CACHE INTERNAL "")
    ...
    set(UTIL_Fortran_FLAGS " -O3 -Wno-argument-mismatch -finteger-4-integer-8 -fdefault-real-8 -fconvert=big-endian -ffree-line-length-0 -ffast-math -fno-second-underscore -frecord-marker=4 -funroll-loops -ggdb -static -Wall -fno-range-check -DWRF -D_REAL8_ -fopenmp" CACHE INTERNAL "")
    ...
    set(UTIL_Fortran_FLAGS " -g -fbacktrace -fconvert=big-endian -ffree-line-length-0 -ffast-math -fno-second-underscore -frecord-marker=4 -funroll-loops -g -ggdb -static -fno-range-check -DWRF -D_REAL8_ -fopenmp" CACHE INTERNAL "")
